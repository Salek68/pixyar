...
Route::get('/login', [AuthController::class,'index'])->withoutMiddleware('web')->name('LorR');
...
Route::middleware('auth:sanctum')->withoutMiddleware('web')->group(function () {
    Route::get('/AdminPanel', [AdminPanelController::class,'index'])->withoutMiddleware('web')->name('AdminPanel.Index');
